...
export default function ChatList({
  ...
  return (
    <div
      className={
        displaySearchBar ? "chatListContainer widen" : "chatListContainer"
      }
    >
      ...
      <div
        ref={chatListRef}
        className={isMobile ? "chatList mobileList" : "chatList"}
